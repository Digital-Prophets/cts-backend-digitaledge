USE [CTSMigrationDB]
GO
/****** Object:  StoredProcedure [dbo].[UpdateAppointmentStatus]    Script Date: 24/01/2022 06:55:02 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
ALTER     PROCEDURE [dbo].[UpdateAppointmentStatus] 
AS 
BEGIN
	...
	AND (app.interactiondate IS NULL OR app.InteractionDate < @Today)
